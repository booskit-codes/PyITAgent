...
class GlobalSettings:
    ...
    def get_config(self):
        ...
        boolean_keys = ['silent_mode', 'slack_logging', 'pyitagent_asset_collection', 'pyitagent_asset_tag_generation', 'pyitagent_asset_monitor_collection']  # Add your boolean keys here
